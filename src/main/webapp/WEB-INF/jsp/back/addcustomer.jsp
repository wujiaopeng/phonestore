		...
		<div class="panel-body col-md-12 ">
			...
			<div class="form-panel">
				<div class=" form">
					...
					method="post" action="${pageContext.request.contextPath }/system/savecustomer">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/addcustomer.js"></script>