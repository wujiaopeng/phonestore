		...
		<div class="panel-body col-md-12 ">
			...
			<div class="form-panel">
				<div class=" form">
					...
					method="post" action="${pageContext.request.contextPath }/system/savemidifymaster">
						...
						<div class="form-group ">
							...
							<div class="col-md-8">
								...
								type="text" readonly="readonly" value="${master.account }" />
							</div>
						...
						<div class="form-group ">
							...
							<div class="col-md-8">
								<input class="form-control " id="password" type="password"
									name="password" value="${master.password }"/>
							</div>
						...
						<div class="form-group ">
							...
							<div class="col-md-8">
								<input class="form-control " id="age" type="number" name="age" value="${master.age }" />
							</div>
						</div>
						<div class="form-group ">
						...
						<div class="form-group ">
							...
							<div class="col-lg-8">
								<input class="form_datetime form-control " id="birth" type="text"  readonly="readonly"
								name="birth" value='<fmt:formatDate value="${master.birth }" pattern="yyyy-MM-dd"/>' onclick="WdatePicker();" />
							</div>
						</div>
						<div class="form-group">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/modifymaster.js"></script>